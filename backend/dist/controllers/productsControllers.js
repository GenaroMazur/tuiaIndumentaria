...
exports.productDelete = exports.productUpdate = exports.productCreate = exports.productDetail = exports.productList = void 0;
...
const productUpdate = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
    }
    catch (error) {
        console.error(error);
